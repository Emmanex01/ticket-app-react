...
export default function Landing() {
  return (
    <div className="flex flex-col min-h-screen w-full overflow-hidden bg-linear-to-b from-white to-blue-50 text-gray-800">
      {/* Decorative Circle Top-Left */}
      <div className="absolute top-12 right-4 w-[180px] h-[180px] bg-amber-400 rounded-full opacity-50 blur-sm"></div>
      ...
      <main className="grow flex flex-col justify-center items-center text-center px-6 md:px-12 relative">
        ...
        {/* Wavy Background */}
        <div className="max-w-[1440px] mx-auto fixed bottom-0 left-0 right-0 overflow-hidden pointer-events-none z-0">
          <svg
              id="wave"
              className="w-full rotate-0 transition-transform duration-300 z-0"
